...
class Callback:
    ...
    @staticmethod
    def from_graph_element(graph_element: GraphElement, skill_modifier: SkillModifier, time: float) -> Callback:
        return Callback(graph_element.build_task(skill_modifier=skill_modifier), time)
