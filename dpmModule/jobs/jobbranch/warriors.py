...
class AuraWeaponBuilder():
    def __init__(self, enhancer, skill_importance, enhance_importance, modifier=core.CharacterModifier(), hit=6):
        ...
        self.target_skill = core.DamageSkill("오라웨폰(파동)", 0, 500 + 20 * enhancer.getV(skill_importance,enhance_importance), hit, modifier=modifier).wrap(core.DamageSkillWrapper)
