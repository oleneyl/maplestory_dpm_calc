...
class JobGenerator(ck.JobGenerator):
    ...
    def generate(self, vEhc, chtr : ck.AbstractCharacter, combat : bool = False):
        ...
        # 최대 10회 공격
        ShieldChasing = core.DamageSkill("실드 체이싱", 540, 500 + 10 * self._combat, 2*2*(8+2), cooltime = 6000, modifier = core.CharacterModifier(armor_ignore = 30, pdamage=20), red = True).isV(vEhc,1,1).wrap(core.SummonSkillWrapper)
