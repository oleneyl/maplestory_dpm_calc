...
class JobGenerator(ck.JobGenerator):
    ...
    def generate(self, vEhc, chtr : ck.AbstractCharacter, options: Dict[str, Any]):
        ...
        return(Divide,
                ...
                [Ether, EtherTick, Resonance, Grave, Blossom, Marker, Ruin, Storm, MirrorBreak, MirrorSpider, Shard] +\
    ...
    def get_skill_rotation_10sec(self, graph: policy.StorageLinkedGraph):
        Order: OrderWrapper = graph.get_element("오더")
        Ether: core.StackSkillWrapper = graph.get_element("에테르")
        for _ in range(3):
            Order.add()
        Ether.set_stack(400)
